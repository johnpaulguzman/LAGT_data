...
probability ( nestit | callfnc ) {
  (0) : 0.7538462, 0.2461538;
  (1) : 0.0, 1.0;
}
probability ( fncdef ) {
   0.7125, 0.2875;
}
probability ( callfnc | pasaddr ) {
  (0) : 1.0, 0.0;
  (1) : 0.6052632, 0.3947368;
}
probability ( pasaddr ) {
   0.525, 0.475;
}
...
probability ( ifseri | ifelse ) {
  (0) : 0.93846154, 0.06153846;
  (1) : 0.2, 0.8;
}
probability ( switch | ifelse ) {
