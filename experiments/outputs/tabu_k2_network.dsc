...
probability ( opaspr | exprn, lrvalue ) {
  (0, 0) : 0.7417219, 0.2582781;
  (1, 0) : 0.6097561, 0.3902439;
  (0, 1) : 0.0, 1.0;
  (1, 1) : 0.2, 0.8;
}
...
probability ( assgn | lrvalue ) {
  (0) : 0.8854167, 0.1145833;
  (1) : 0.2264151, 0.7735849;
}
probability ( arith | exprn ) {
  (0) : 0.92827004, 0.07172996;
  (1) : 0.5540541, 0.4459459;
}
probability ( logrel | opaspr, assgn, exprn ) {
  (0, 0, 0) : 0.990990991, 0.009009009;
  (1, 0, 0) : 0.8113208, 0.1886792;
  (0, 1, 0) : 1.0, 0.0;
  (1, 1, 0) : 0.6470588, 0.3529412;
  (0, 0, 1) : 0.5625, 0.4375;
  (1, 0, 1) : 0.07142857, 0.92857143;
  (0, 1, 1) : 0.125, 0.875;
  (1, 1, 1) : 0.06451613, 0.93548387;
}
