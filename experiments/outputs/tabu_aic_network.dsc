...
probability ( opaspr | assgn, logrel ) {
  (0, 0) : 0.7300613, 0.2699387;
  (1, 0) : 0.2105263, 0.7894737;
  (0, 1) : 0.2580645, 0.7419355;
  (1, 1) : 0.2470588, 0.7529412;
}
...
probability ( lrvalue | opaspr, assgn ) {
  (0, 0) : 1.0, 0.0;
  (1, 0) : 0.641791, 0.358209;
  (0, 1) : 0.4, 0.6;
  (1, 1) : 0.1518987, 0.8481013;
}
...
probability ( elseif | exprn, selcpt, break ) {
