...
probability ( itcpt | dtype ) {
  (0) : 0.4047619, 0.5952381;
  (1) : 0.6578947, 0.3421053;
}
probability ( selcpt ) {
   0.55, 0.45;
}
probability ( fncpar | dtype ) {
  (0) : 0.5, 0.5;
  (1) : 0.7368421, 0.2631579;
}
probability ( countit | constl ) {
  (0) : 0.6875, 0.3125;
  (1) : 0.4166667, 0.5833333;
}
probability ( eventit | logrel ) {
  (0) : 0.6666667, 0.3333333;
  (1) : 0.3947368, 0.6052632;
}
probability ( multi ) {
   0.4875, 0.5125;
}
...
probability ( beflp | decl ) {
  (0) : 0.3888889, 0.6111111;
  (1) : 0.7045455, 0.2954545;
}
